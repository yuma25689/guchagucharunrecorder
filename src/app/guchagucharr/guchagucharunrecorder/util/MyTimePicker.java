...
public class MyTimePicker extends FrameLayout {
    ...
    public MyTimePicker(Context context, AttributeSet attrs) {
    	this(context, attrs, Resources.getSystem().getIdentifier("attr", "timePickerStyle", "android"));//android.R.attr.timePickerStyle);
    }
    ...
    public MyTimePicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray attributesArray = context.obtainStyledAttributes(
                attrs,
                // 本当にこれでいいのだろうか・・・
                Resources.getSystem().getIntArray(Resources.getSystem().getIdentifier("styleable", "TimePicker", "android")),
                //R.styleable.TimePicker
                defStyle, 0);
        int layoutResourceId = attributesArray.getResourceId(
        		Resources.getSystem().getIdentifier("styleable", "TimePicker_internalLayout", "android"),
                // R.styleable.TimePicker_internalLayout, 
        		Resources.getSystem().getIdentifier("layout", "timePickerStyle", "android"));
        ...
        // hour
        mHourSpinner = (NumberPicker) findViewById(Resources.getSystem().getIdentifier("id","hour",null));//R.id.hour);
        ...
        mHourSpinnerInput = (EditText) mHourSpinner.findViewById(Resources.getSystem().getIdentifier("id","numberpicker_input",null));//R.id.numberpicker_input);
        mHourSpinnerInput.setImeOptions(EditorInfo.IME_ACTION_NEXT);

        // divider (only for the new widget style)
        mDivider = (TextView) findViewById(Resources.getSystem().getIdentifier("id","divider",null));//R.id.divider);
        if (mDivider != null) {
            mDivider.setText(Resources.getSystem().getIdentifier("string","time_picker_separator",null));//R.string.time_picker_separator);
        }

        // minute
        mMinuteSpinner = (NumberPicker) findViewById(
        		Resources.getSystem().getIdentifier("id", "minute", null) );
        		//R.id.minute);
        ...
        mMinuteSpinnerInput = (EditText) mMinuteSpinner.findViewById(
        		Resources.getSystem().getIdentifier("id", "numberpicker_input", null )
        		);
        ...
        View amPmView = findViewById(
        		Resources.getSystem().getIdentifier("id", "amPm", null)
        		);
        		//R.id.amPm);
    ...
    private void setContentDescriptions() {
        ...
        trySetContentDescription(mMinuteSpinner,
        		Resources.getSystem().getIdentifier("id", "increment", null ),
        		//R.id.increment,
        		Resources.getSystem().getIdentifier("string", "time_picker_increment_minute_button", null ));
                //R.string.time_picker_increment_minute_button);
        trySetContentDescription(mMinuteSpinner,
        		Resources.getSystem().getIdentifier("id", "decrement", null ),
        		//R.id.decrement,
        		Resources.getSystem().getIdentifier("string", "time_picker_decrement_minute_button", null ) );
                //R.string.time_picker_decrement_minute_button);
        // Hour
        trySetContentDescription(mHourSpinner,
        		Resources.getSystem().getIdentifier("id", "increment", null ),
        		//R.id.increment,
        		Resources.getSystem().getIdentifier("string", "time_picker_increment_hour_button", null ));
        ...
        if (mAmPmSpinner != null) {
            trySetContentDescription(mAmPmSpinner,
            		Resources.getSystem().getIdentifier("id", "increment", null ),
            		//R.id.increment,
            		Resources.getSystem().getIdentifier("string", "time_picker_increment_set_pm_button", null ) );            		
                    //R.string.time_picker_increment_set_pm_button);
            trySetContentDescription(mAmPmSpinner,
            		Resources.getSystem().getIdentifier("id", "decrement", null ),            		
            		//R.id.decrement,
            		Resources.getSystem().getIdentifier("string", "time_picker_decrement_set_am_button", null ) );            		
