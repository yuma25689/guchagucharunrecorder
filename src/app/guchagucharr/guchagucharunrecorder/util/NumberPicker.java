...
public class NumberPicker extends LinearLayout implements OnClickListener,
    ...
    public NumberPicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        ViewGroup parent = (ViewGroup) inflater.inflate(R.layout.number_picker, this, true);
        mHandler = new Handler();
        InputFilter inputFilter = new NumberPickerInputFilter();
        mNumberInputFilter = new NumberRangeKeyListener();
        mIncrementButton = (NumberPickerButton) parent.findViewById(R.id.increment);
        mIncrementButton.setOnClickListener(this);
        mIncrementButton.setOnLongClickListener(this);
        mIncrementButton.setNumberPicker(this);
        mDecrementButton = (NumberPickerButton) parent.findViewById(R.id.decrement);
