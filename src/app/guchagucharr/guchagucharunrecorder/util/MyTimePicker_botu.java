 ...
 * </p>
 */
public class MyTimePicker_botu extends FrameLayout {
    ...
    private static final OnTimeChangedListener NO_OP_CHANGE_LISTENER = new OnTimeChangedListener() {
        public void onTimeChanged(MyTimePicker_botu view, int hourOfDay, int minute, int second) {
        }
    };
    ...
    public interface OnTimeChangedListener {
         ...
         */
        void onTimeChanged(MyTimePicker_botu view, int hourOfDay, int minute, int second);
    }

    public MyTimePicker_botu(Context context) {
        this(context, null);
    }

    public MyTimePicker_botu(Context context, AttributeSet attrs) {
    	this(context, attrs, Resources.getSystem().getIdentifier("timePickerStyle", "attr", "android"));//android.R.attr.timePickerStyle);
    }

    public MyTimePicker_botu(Context context, AttributeSet attrs, int defStyle) {
        ...
        int idTimePickerAttr = Resources.getSystem().getIdentifier("TimePicker", "styleable", "android");
        int[] attrTimePicker = null;
        if( idTimePickerAttr != 0 )
        {
        	attrTimePicker = Resources.getSystem().getIntArray(idTimePickerAttr);
        }
        ...
        int layoutResourceId = attributesArray.getResourceId(
        		Resources.getSystem().getIdentifier("TimePicker_internalLayout", "styleable", "android"),
        ...
        LinearLayout topLayout = 
        		(LinearLayout) findViewById(Resources.getSystem().getIdentifier("timePickerLayout","id",null));
        
        LinearLayout parentLayout = (LinearLayout) topLayout.getChildAt(0);
        // hour
        mHourSpinner = (NumberPicker) findViewById(Resources.getSystem().getIdentifier("hour","id",null));//R.id.hour);
        ...
        mHourSpinnerInput = (EditText) mHourSpinner.findViewById(Resources.getSystem().getIdentifier("numberpicker_input","id",null));//R.id.numberpicker_input);
        mHourSpinnerInput.setImeOptions(EditorInfo.IME_ACTION_NEXT);

        // divider (only for the new widget style)
        mDivider = (TextView) findViewById(Resources.getSystem().getIdentifier("divider","id","android"));//R.id.divider);
        if (mDivider != null) {
            mDivider.setText(Resources.getSystem().getIdentifier("time_picker_separator","string","android"));//R.string.time_picker_separator);
        }
        ...
        mMinuteSpinner.setFormatter(sTwoDigitFormatter);//NumberPicker.getTwoDigitFormatter());
        ...
        if (mDividerSecond != null) {
        	mDividerSecond.setText(Resources.getSystem().getIdentifier("time_picker_separator","string",null));//R.string.time_picker_separator);
        }
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(MyTimePicker_botu.class.getName());
    }

    @Override
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        super.onInitializeAccessibilityNodeInfo(info);
        info.setClassName(MyTimePicker_botu.class.getName());
    }
    ...
    private void updateHourControl() {
        if (is24HourView()) {
            ...
            mHourSpinner.setFormatter(sTwoDigitFormatter);//NumberPicker.getTwoDigitFormatter());
        } else {
