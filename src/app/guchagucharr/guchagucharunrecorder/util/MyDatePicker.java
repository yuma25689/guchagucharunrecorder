...
public class MyDatePicker extends FrameLayout {
    ...
    private static final String LOG_TAG = MyDatePicker.class.getSimpleName();
...
//                R.styleable.DatePicker_calendarViewShown, DEFAULT_CALENDAR_VIEW_SHOWN);
        ...
        NumberPicker.OnChangedListener onChangeListener = new NumberPicker.OnChangedListener() {
...
//        });
        ...
        mDaySpinner.setFormatter(NumberPicker.TWO_DIGIT_FORMATTER);//getTwoDigitFormatter());
        //mDaySpinner.setOnLongPressUpdateInterval(100);
        mDaySpinner.setOnChangeListener(onChangeListener);
        mDaySpinnerInput = (EditText) mDaySpinner.findViewById(R.id.numberpicker_input);

        // month
        mMonthSpinner = (NumberPicker) findViewById(R.id.month);
        mMonthSpinner.setRange(0, mNumberOfMonths - 1);
//        mMonthSpinner.setMinValue(0);
//        mMonthSpinner.setMaxValue(mNumberOfMonths - 1);
        //mMonthSpinner.setDisplayedValues(mShortMonths);
        //mMonthSpinner.setOnLongPressUpdateInterval(200);
        mMonthSpinner.setOnChangeListener(onChangeListener);
        mMonthSpinnerInput = (EditText) mMonthSpinner.findViewById(R.id.numberpicker_input);

        // year
        mYearSpinner = (NumberPicker) findViewById(R.id.year);
        //mYearSpinner.setOnLongPressUpdateInterval(100);
        mYearSpinner.setOnChangeListener(onChangeListener);
...
//
    ...
    public boolean getCalendarViewShown() {
        return false; // (mCalendarView.getVisibility() == View.VISIBLE);
    }
...
//        	mDaySpinner.setRange(mCurrentDate.get(Calendar.DAY_OF_MONTH), 
//        			mCurrentDate.getActualMaximum(Calendar.DAY_OF_MONTH));
////            mDaySpinner.setMinValue(mCurrentDate.get(Calendar.DAY_OF_MONTH));
////            mDaySpinner.setMaxValue(mCurrentDate.getActualMaximum(Calendar.DAY_OF_MONTH));
//            //mDaySpinner.setWrapSelectorWheel(false);
//           // mMonthSpinner.setDisplayedValues(null);
//        	mMonthSpinner.setRange(mCurrentDate.get(Calendar.MONTH),
//        			mCurrentDate.getActualMaximum(Calendar.MONTH));
////            mMonthSpinner.setMinValue(mCurrentDate.get(Calendar.MONTH));
////            mMonthSpinner.setMaxValue(mCurrentDate.getActualMaximum(Calendar.MONTH));
////            mMonthSpinner.setWrapSelectorWheel(false);
//        } else if (mCurrentDate.equals(mMaxDate)) {
//        	mDaySpinner.setRange(mCurrentDate.getActualMinimum(Calendar.DAY_OF_MONTH),
//        		mCurrentDate.get(Calendar.DAY_OF_MONTH));
////            mDaySpinner.setMinValue(mCurrentDate.getActualMinimum(Calendar.DAY_OF_MONTH));
////            mDaySpinner.setMaxValue(mCurrentDate.get(Calendar.DAY_OF_MONTH));
////            mDaySpinner.setWrapSelectorWheel(false);
////            mMonthSpinner.setDisplayedValues(null);
//        	mMonthSpinner.setRange(mCurrentDate.getActualMinimum(Calendar.MONTH),
//        			mCurrentDate.get(Calendar.MONTH));
////            mMonthSpinner.setMinValue(mCurrentDate.getActualMinimum(Calendar.MONTH));
////            mMonthSpinner.setMaxValue(mCurrentDate.get(Calendar.MONTH));
////            mMonthSpinner.setWrapSelectorWheel(false);
//        } else {
        	mDaySpinner.setRange(1, mCurrentDate.getActualMaximum(Calendar.DAY_OF_MONTH));
//            mDaySpinner.setMinValue(1);
//            mDaySpinner.setMaxValue(mCurrentDate.getActualMaximum(Calendar.DAY_OF_MONTH));
//            mDaySpinner.setWrapSelectorWheel(true);
//            mMonthSpinner.setDisplayedValues(null);
        	mMonthSpinner.setRange(1,12);//0,11);
//            mMonthSpinner.setMinValue(0);
...
//                mMonthSpinner.getMinValue(), mMonthSpinner.getMaxValue() + 1);
        ...
        mYearSpinner.setRange(2000, 2100);//mMinDate.get(Calendar.YEAR),mMaxDate.get(Calendar.YEAR));
//        mYearSpinner.setMinValue(mMinDate.get(Calendar.YEAR));
//        mYearSpinner.setMaxValue(mMaxDate.get(Calendar.YEAR));
//        mYearSpinner.setWrapSelectorWheel(false);

        // set the spinner values
        mYearSpinner.setCurrent(mCurrentDate.get(Calendar.YEAR));
        mMonthSpinner.setCurrent(mCurrentDate.get(Calendar.MONTH)+1);
        mDaySpinner.setCurrent(mCurrentDate.get(Calendar.DAY_OF_MONTH));
    }
